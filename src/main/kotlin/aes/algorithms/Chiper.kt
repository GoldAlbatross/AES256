...
class CipherWithModeAndPadding(
    val cipher: Cipher,
    val mode: CipherMode,
...
fun Cipher.with(mode: CipherMode, padding: CipherPadding, iv: ByteArray? = null): CipherWithModeAndPadding =
    CipherWithModeAndPadding(this, mode, padding, iv)

operator fun Cipher.get(mode: CipherMode, padding: CipherPadding, iv: ByteArray? = null): CipherWithModeAndPadding =
    with(mode, padding, iv)